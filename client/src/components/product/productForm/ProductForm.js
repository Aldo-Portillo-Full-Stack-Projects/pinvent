    ...
    <div className='add-product'>
        <Card cardClass={"card"}>
            <form onSubmit={saveProduct}>
                ...
                <input type="text" placeholder='Product name' name="name" value={product?.name} onChange={handleInputChange}/> {/*Added optional chaining since product.name is undefined til we start typing */}
                <label>Product Category:</label>
                <input type="text" placeholder='Product Category' name="category" value={product?.category} onChange={handleInputChange}/> {/*Added optional chaining since product.name is undefined til we start typing */}
